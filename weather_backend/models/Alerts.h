...
class Alerts
{
  public:
     ...
     */
    explicit Alerts(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Alerts(const Json::Value &pJson) noexcept(false);
     ...
     */
    Alerts(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Alerts>;
    friend drogon::orm::BaseBuilder<Alerts, true, true>;
    friend drogon::orm::BaseBuilder<Alerts, true, false>;
    friend drogon::orm::BaseBuilder<Alerts, false, true>;
    friend drogon::orm::BaseBuilder<Alerts, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Alerts>;
#endif
